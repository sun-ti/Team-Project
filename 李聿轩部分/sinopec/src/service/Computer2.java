				...
				if(parameters!=null&&!parameters.equals("")) {
					...
					if(object.has("clientIp")&&object.has("oilGunNum")) {
						...
						if(array.size()!=0) {
							...
							if(orderObj.has("orderNum")&&orderObj.has("price")&&
							   orderObj.has("quantity")&&orderObj.has("money")&&
							   orderObj.has("payType")&&orderObj.has("cardNum")&&
							   orderObj.has("oilGunNum")&&orderObj.has("startTime")&&
							   orderObj.has("endTime")&&orderObj.has("plateOld")&&orderObj.has("plate")
								) {
