...
public class Query_Station extends Util_DBase implements Utils_DBase{
	...
	public String add() {
		...
		String uuid	=null,stationid=null,name=null,state="0";
		long   datetime1=System.currentTimeMillis();
		String datetime =getCurrentDatetime(datetime1),sql="";
		...
		sql	=	"insert into station values('"+uuid+"','"+stationid+"','"+name+"',"+state+",'"+datetime+"',"+datetime1+")";
