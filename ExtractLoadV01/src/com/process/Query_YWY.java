...
public class Query_YWY extends Util_DBase implements Utils_DBase{

	//	网络的操作控件;
	private Util_Net util_Net;
	public Query_YWY(Util_Net util_Net) {
		super();
	...
	public String query() {
		...
		String autoid=null,uuid = null, nodeno = null, xql = null, ps_date = null, cp_no = null, depot_code = null, psd_id = null,
				oils_id = null,state=null,currentpage = null, limitcount = null, sqlall = "", sql="";
		...
		sqlall= "select count(autoid) from ywy "+where+" order by autoid desc";
	...
	public String add() {
		...
		String uuid	=getUUID(),nodeno=null,xql=null,ps_date=null,cp_no=null,depot_code=null,psd_id=null,oils_id=null,state="0";
		String sql="";
